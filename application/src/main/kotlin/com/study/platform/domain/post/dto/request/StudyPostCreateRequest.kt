...
data class StudyPostCreateRequest @JsonCreator constructor(

    @JsonProperty("title")
    @field:Schema(description = "제목", example = "Spring Boot 스터디 모집합니다")
    @field:NotBlank(message = "제목은 필수입니다.")
    val title: String,

    @JsonProperty("description")
    @field:Schema(description = "내용", example = "주 2회 온라인으로 진행합니다")
    ...
    @field:Schema(description = "최대 인원", example = "5")
    @field:Min(value = 2, message = "최대 인원은 2명 이상이어야 합니다.")
    @field:Max(value = 100, message = "최대 인원은 100명 이하여야 합니다.")
    val maxMembers: Int,

    @JsonProperty("deadline")
    @field:Schema(description = "모집 마감일", example = "2026-04-01T23:59:59")
