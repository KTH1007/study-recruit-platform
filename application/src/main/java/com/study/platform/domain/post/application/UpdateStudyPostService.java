...
public class UpdateStudyPostService implements UpdateStudyPostUseCase {
    ...
    public StudyPostResponse execute(UUID userId, UUID postId, StudyPostUpdateRequest request) {
